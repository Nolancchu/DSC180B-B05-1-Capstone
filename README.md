...
5. For the final model, download sliiders-v1.2.zar.zip at link: https://zenodo.org/records/10909655, open the projected costs folder and run file: run_pyciam_regional_rise.ipynb.

6. To generate the visualizations
    A. Download https://drive.google.com/file/d/1Dk3DYOhaYahwIBE-Kxa8t4NTuqE8d1fL/view?usp=sharing and place it in the repository
    B. Download https://drive.google.com/file/d/1VW4dHIp7_befuztdh3rXQqmqt-TfU901/view?usp=sharing, and place it in the projected_costs folder. This contains the packages required for the map visualizations of costs.
    C. Run visualizations_merged.ipynb
